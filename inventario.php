<?php
    ...
    /* Obtener categorías */
    $sql = "SELECT idcategoria, descripcion FROM categoria ORDER BY idcategoria";
...
<body>
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-space-between">
                                <h4 class="mb-4 mb-md-0 card-title">Inventario</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" id="precio" placeholder="S/." class="form-control">
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="d-flex" style="justify-content: flex-end;">
                                <button id="btnAdd" class="btn btn-dark">Agregar</button>
                            </div>
  ...
  <script>
    ...
    document.getElementById('btnAdd').addEventListener('click', () => {
        ...
        if (!descripcion || !stock || !precio || !categoria) {
            Swal.fire('Error', 'Complete todos los campos', 'warning');
            return;
        }

        const url = idInventario
            ? 'php/inventario/inventario_update.php'
            : 'php/inventario/inventario_insert.php';
        ...
        .then(data => {
            if (data.success) {
                ...
                Swal.fire('Éxito', idInventario ? 'Producto actualizado' : 'Producto agregado', 'success');
                ...
                document.getElementById('btnAdd').textContent = 'Agregar';
    ...
    $(document).ready(function () {
        $('#tablaInventario').DataTable({
            ajax: 'php/inventario/inventario_listar.php',
            language: {
    ...
    $('#tablaInventario').on('click', '.btnEditar', function () {
        ...
        fetch(`php/inventario/inventario_get.php?id=${id}`)
            .then(res => res.json())
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('categoria').value    = data.data.idcategoria;

                    document.getElementById('btnAdd').textContent = 'Actualizar';
                    document.getElementById('btnAdd').dataset.mode = 'edit';
    ...
    $('#tablaInventario').on('click', '.btnEliminar', function () {
        const id = $(this).data('id');
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch('php/inventario/inventario_delete.php', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
