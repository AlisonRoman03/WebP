...
<body>
    ...
    <div class="page-wrapper">
      ...
      <div class="body-wrapper">
        <div class="container-fluid">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-space-between">
                                <h4 class="mb-4 mb-md-0 card-title">Órdenes</h4>
            ...
            <div class="card">
              <div class="card-body">
                <button type="button" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#eventModal">
                      Añadir menú
                </button>
              </div>
            ...
            <div class="modal fade" id="eventModal" tabindex="-1" aria-labelledby="eventModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                  ...
                  <!-- MODAL PARA EDITAR/AÑADIR MENÚS -->
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 mt-6">
                          <div>
                            ...
                            <input id="txtunidad" type="number" class="form-control" />
                          </div>
                        </div>
                      </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <!-- <button type="button" id="actmenu" class="btn btn-success btn-update-event" data-fc-event-public-id="">
                      Actualizar cambios
                    </button> -->
                    <button type="button" id="addmenu" class="btn btn-primary btn-add-event">
                      Añadir menú
                    </button>
                  </div>
                </div>
            ...
            <div class="card card-body" id="detalle" style="display:none">
              <div class="d-flex mb-2" style="justify-content: space-between; align-items: center;">
                <div>
                  <label class="form-label">Detalle Menú: <strong id="lblMenu"></label>
                </div>
                <div>
                  <button type="button" class="btn btn-dark" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
              ...
              <div id="flush-collapseOne" class="accordion-collapse collapse mb-3" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                      <div class="accordion-body px-3 fw-normal">
                        <div class="row">
                          <div class="col-md-4">
                            <label class="form-label">Cliente</label>
                                <div class="input-group">
                                  ...
                                  <button type="button" class="btn btn-primary d-flex align-items-center justify-content-center" data-bs-toggle="modal" data-bs-target="#vertical-center-modal">
                                    <i class="fs-5 ti ti-user-plus"></i>
                                  </button>
                                </div>                            
                            </div>
                          ...
                          <div class="col-md-2">
                            <label class="form-label">Hora</label>
                            <input class="form-control" id="txthorac" type="time"/>
                          </div>

                          <div class="col-md-2">
                            <label class="form-label">Cantidad</label>
                            <input class="form-control" id="txtcantidad" type="number"/>
                          </div>
              ...
              <div class="table-responsive border rounded-1">
                  <table class="table mb-0" id="tb-ordenes">
  ...
  document.addEventListener("DOMContentLoaded", function () {
      ...
      calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          eventContent: function (arg) {
            const descripcion = arg.event.title;
            const partes = descripcion.split(",");

            let html = `
              <div class="menu-event fc-bg-primary">
              <div class="fc-daygrid-event-dot"></div>
                ${partes[0] ? `<div><strong>Entrada:</strong> ${partes[0].trim()}</div>` : ""}
                ${partes[1] ? `<div><strong>Fondo:</strong> ${partes[1].trim()}</div>` : ""}
                ${partes[2] ? `<div><strong>Refresco:</strong> ${partes[2].trim()}</div>` : ""}
              </div>
            `;
          ...
          eventClick: function (info) {
            ...
            // Guardar ID del menú seleccionado
            detalle.dataset.idmenu = evento.id;

            // Mostrar nombre del menú
            document.getElementById('lblMenu').innerText = evento.title;

            // Limpiar tabla y cargar órdenes
            cargarOrdenes(evento.id);
          }
  ...
  document.getElementById("addmenu").addEventListener("click", function () {
    ...
    if (!descripcion || !precio || !unidad || !fecha || !hora) {
      Swal.fire("Error", "Complete todos los campos", "warning");
      return;
    }

    fetch("php/menu/menu_insert.php", {
      method: "POST",
  ...
  $('#vertical-center-modal').on('shown.bs.modal', function () {
      ...
      if (!$cliente.hasClass('select2-hidden-accessible')) {
          ...
          $cliente.select2({
              ...
              allowClear: true,
              width: '100%',
              dropdownParent: $('#vertical-center-modal'),
              ajax: {
                  url: 'php/ordenes/clientes_listar.php',
                  dataType: 'json',
                  delay: 250,
  ...
  $('#vertical-center-modal').on('hidden.bs.modal', function () {
    $('#cliente').val(null).trigger('change');
  });

  function cargarOrdenes(idmenu) {

    fetch(`php/ordenes/ordenes_listar.php?idmenu=${idmenu}`)
      .then(res => res.json())
      .then(data => {
        ...
        data.forEach(row => {
          html += `
            <tr>
              ...
              <td>
                <span 
                  class="text-primary btnEditar"
                  data-idorden="${row.idorden}"
                  data-cliente="${row.cliente}"
                  data-cantidad="${row.cantidad}"
                  data-hora="${row.hora}"
                  style="cursor:pointer;">
                  <iconify-icon icon="solar:pen-new-square-line-duotone" width="24"></iconify-icon>
                </span>

                <span class="text-danger btnEliminar ms-2"
                  data-idorden="${row.idorden}"
                  style="cursor:pointer;">
                  <iconify-icon icon="solar:trash-bin-minimalistic-line-duotone" width="24"></iconify-icon>
                </span>
              </td>
            </tr>
          `;
        ...
        document.querySelector('#tb-ordenes tbody').innerHTML = html;
      });
  }

  document.getElementById('btnadd').addEventListener('click', function () {

  // 👉 Si existe, es edición; si no, es nuevo registro
  const idorden = document.getElementById('idorden').value || null;

  const detalle = document.getElementById('detalle');

  const idmenu    = detalle.dataset.idmenu;
  const cliente   = document.getElementById('txtcliente').value.trim();
  const hora      = document.getElementById('txthorac').value;
  const cantidad  = document.getElementById('txtcantidad').value;
  const idcliente = document.getElementById('idcliente').value || null;

  // 🔎 Validación
  if (!cliente || !hora || !cantidad) {
    Swal.fire({
      icon: 'warning',
  ...
  fetch('php/ordenes/ordenes_guardar.php', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
  ...
  .then(resp => {
    ...
    if (resp.ok) {
      ...
      // Recargar tabla
      cargarOrdenes(idmenu);

      // Limpiar formulario
      document.getElementById('idorden').value     = '';
      document.getElementById('txtcliente').value  = '';
      document.getElementById('txthorac').value    = '';
      document.getElementById('txtcantidad').value = '';
      document.getElementById('idcliente').value   = '';

      Swal.fire({
        icon: 'success',
        title: idorden ? 'Registro actualizado' : 'Registro guardado',
        text: idorden
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: resp.msg || 'No se pudo guardar la orden'
      });
...
document.querySelector('#tb-ordenes tbody').addEventListener('click', function (e) {
  ...
  document.getElementById('txthorac').value    = hora;
});
...
document.querySelector('#tb-ordenes tbody').addEventListener('click', function (e) {
  ...
  Swal.fire({
    ...
    fetch('php/ordenes/ordenes_eliminar.php', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
    ...
    .then(resp => {
      ...
      if (resp.ok) {
        ...
        cargarOrdenes(idmenu); // refresca tabla
